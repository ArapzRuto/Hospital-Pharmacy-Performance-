...
2.	Does a higher number of patient visits always lead to higher pharmacy revenue? No, a higher number of patient visits does NOT always lead to higher pharmacy revenue. Why? Because revenue depends on: Type of medication prescribed, Quantity dispensed, Unit price, and whether visits result in prescriptions at all 
